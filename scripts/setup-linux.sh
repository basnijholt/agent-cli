...
if ! pkg-config --exists portaudio-2.0 2>/dev/null; then
    ...
    echo ""
    echo "Ubuntu/Debian (recommended - includes Python bindings):"
    echo "  sudo apt install python3-pyaudio"
    echo ""
    echo "Ubuntu/Debian (alternative - for pip install):"
    echo "  sudo apt install libportaudio2 libportaudio-dev"
    echo ""
    echo "Fedora/RHEL/CentOS:"
    echo "  sudo dnf install portaudio-devel python3-devel"
    echo "  # or: sudo yum install portaudio-devel python3-devel"
    echo ""
    echo "Arch Linux:"
    echo "  sudo pacman -S portaudio python"
    echo ""
    echo "openSUSE:"
    echo "  sudo zypper install portaudio-devel python3-devel"
    echo ""
