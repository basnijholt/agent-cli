...
These commands require tmux and work with tracked agents (launched via `dev new -a` or `dev agent --tab`).
...
```bash
agent-cli dev poll [OPTIONS]
```

<!-- CODE:START -->
<!-- from agent_cli.docs_gen import all_options_for_docs -->
<!-- print(all_options_for_docs("dev.poll")) -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
<!-- ⚠️ This content is auto-generated by `markdown-code-runner`. -->
### Options
...
```bash
agent-cli dev output NAME [OPTIONS]
```

<!-- CODE:START -->
<!-- from agent_cli.docs_gen import all_options_for_docs -->
<!-- print(all_options_for_docs("dev.output")) -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
<!-- ⚠️ This content is auto-generated by `markdown-code-runner`. -->
### Options
...
| Option | Default | Description |
|--------|---------|-------------|
| `--lines, -n` | `50` | Number of lines to capture |
...
agent-cli dev output my-feature

# Last 200 lines
agent-cli dev output my-feature -n 200
```
...
```bash
agent-cli dev send NAME MESSAGE [OPTIONS]
```

<!-- CODE:START -->
<!-- from agent_cli.docs_gen import all_options_for_docs -->
<!-- print(all_options_for_docs("dev.send")) -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
<!-- ⚠️ This content is auto-generated by `markdown-code-runner`. -->
### Options
...
| Option | Default | Description |
|--------|---------|-------------|
| `--no-enter` | `false` | Don't press Enter after sending |
...
agent-cli dev send my-feature "Fix the failing tests"

# Send without pressing Enter
agent-cli dev send my-feature "/exit" --no-enter
```
...
```bash
agent-cli dev wait NAME [OPTIONS]
```

<!-- CODE:START -->
<!-- from agent_cli.docs_gen import all_options_for_docs -->
<!-- print(all_options_for_docs("dev.wait")) -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
<!-- ⚠️ This content is auto-generated by `markdown-code-runner`. -->
### Options
...
| Option | Default | Description |
|--------|---------|-------------|
| `--timeout, -t` | `0` | Timeout in seconds (0 = no timeout) |
...
| Code | Meaning |
|------|---------|
| 0 | Agent finished (done or quiet) |
...
```bash
# Wait indefinitely
agent-cli dev wait my-feature

# Wait up to 5 minutes
agent-cli dev wait my-feature --timeout 300

# Poll every 2 seconds
agent-cli dev wait my-feature -i 2
```
