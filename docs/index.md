...
<!-- CODE:START -->
<!-- from agent_cli.docs_gen import readme_section -->
<!-- print(readme_section("why-i-built-this")) -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
...
I use it mostly for the [`transcribe`](#transcribe) command when working with LLMs. Being able to speak naturally means I can provide more context without the typing fatigue.
