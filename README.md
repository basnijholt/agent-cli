...
```yaml
 ...
 A hands-free voice assistant that starts and stops recording based on a wake
 word.
...
╰──────────────────────────────────────────────────────────────────────────────╯
╭─ Wake Word Options ──────────────────────────────────────────────────────────╮
│ --wake-word-server-ip          TEXT  Wyoming wake word server IP address.    │
│                                      [default: localhost]                    │
│ --wake-word-server-port        INTEGER  Wyoming wake word server port.       │
│                                         [default: 10400]                     │
│ --wake-word                    TEXT  Wake word to listen for.                │
│                                      [default: ok_nabu]                      │
│ --recording-timeout-seconds    FLOAT  Seconds of silence before recording   │
│                                       stops.                                │
│                                       [default: 2.0]                         │
│ --recording-buffer-seconds     FLOAT  Seconds of audio to buffer before     │
│                                       wake word.                            │
│                                       [default: 1.0]                         │
╰──────────────────────────────────────────────────────────────────────────────╯
╭─ ASR (Audio) Options ────────────────────────────────────────────────────────╮
