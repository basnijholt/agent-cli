...
- **Start Server**: `agent-cli rag-server --docs-folder ~/Documents/Notes --llama-url http://localhost:11434/v1`
...
```yaml
 ...
 OpenAI-compatible API that proxies requests to a backend LLM (like
 llama.cpp), injecting relevant context from the documents.
...
│                                 [default: ./rag_db]                          │
│ --llama-url            TEXT     URL of the llama.cpp server                  │
